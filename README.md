...
Ma force : combiner  
🔹 une solide compréhension **métier banque**,  
🔹 des compétences techniques orientées **performance**,  
🔹 une approche **rigoureuse, claire et pédagogique**.
...
- **Détection de faux billets** – Machine Learning + analyses & visualisations  
- **Étude de marché** – ACP, clustering, analyse de positionnement  
...
✔ construire des dashboards fiables & utiles  
✔ améliorer la qualité des données  
✔ contribuer à des projets Data / BI structurants  
✔ travailler avec des équipes IT, Data & métier

---

## 📬 Contact

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?logo=linkedin&logoColor=white&style=flat-square)](https://www.linkedin.com/in/david-d-abb31b152/)
